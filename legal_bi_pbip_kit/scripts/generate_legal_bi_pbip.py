...
def generate_data(opts: GeneratorOptions) -> Dict[str, List[dict]]:
    ...
    if not sidley_name_pool:
        logging.getLogger("generate_legal_bi_pbip").warning(
        ...
        "annotations": [
            {"name": "demoPurpose", "value": "Sidley Austin BI modernization interview demo"},
            {
                ...
                "value": (
                    ...
                    "Time Intelligence calc group, RLS sample roles). Regenerate: py scripts\\\\generate_legal_bi_pbip.py "
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.epilog = (
        ...
        "  py scripts\\generate_legal_bi_pbip.py --rows 8000\n"
        "  py scripts\\generate_legal_bi_pbip.py --interview --rows 3000"
    )
    return p
...
def main(argv: List[str] | None = None) -> int:
    ...
    log = logging.getLogger("generate_legal_bi_pbip")
